...
public class Matrix implements ActionListener
{
    ...
    private void ChooseOperation ()
    {
        ...
        ImageIcon chooseImage = new ImageIcon(getClass().getResource("operation.png")) ;
        ...
        nMultiplyB = new JButton ("Multiplying by scalar");
    ...
    private static void guiMultiplyByScalar ()
    {
        ...
        tempString = JOptionPane.showInputDialog(null, "Enter the scalar number for multiplying");
        ...
        results = multiplyByScalar(myMatrix, x);
        showMatrix(results, "Multiplication Result");
    }
    ...
    private static double getValue (double [][] matrix)
    {
        ...
        for(temp = 1; temp < res.length; temp++)
        {
            for(temp1 = 0; temp1 < temp; temp1++)
            {
                ...
                {
                    zeroCounter = 0;
                    coefficient = res[temp][temp1]/res[temp1][temp1];
                }
                for(temp2 = 0; temp2 < res.length; temp2++)
                {
                    res[temp][temp2] = res[temp][temp2]  - res[temp1][temp2] * coefficient;
                    if(res[temp][temp2] == 0 )
                        zeroCounter++;
                }
